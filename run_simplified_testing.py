#!/usr/bin/env python3
"""
Simplified testing and visualization script for model performance analysis
"""
...
def main():
    """Run simplified testing and generate visualizations"""
    
    print("="*80)
    print("SIMPLIFIED MODEL TESTING AND PERFORMANCE VISUALIZATION")
    print("="*80)
    
    # Simplified configuration to avoid warnings and performance issues
    config = {
        ...
        'models': ['random_forest', 'xgboost'],  # Removed ensemble to avoid complexity
        'save_models': True,
    ...
    print("\nStarting simplified testing pipeline...")
    ...
    if results['success']:
        ...
        print(f"\n❌ Simplified testing failed: {results['error']}")
        return 1
